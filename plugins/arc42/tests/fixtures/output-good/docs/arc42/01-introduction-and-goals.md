...
<!-- GAP:human-input section:01.3 reason:stakeholders-require-domain-knowledge -->

_Stakeholder information requires human input and cannot be derived from source code alone.
Please fill in the stakeholders table with the actual project participants._
